...
public class Dashboard extends CommandBase {
    ...
    private void configureJoystick() {
        ...
        Shuffleboard.getTab("Joystick").addBoolean("Button 4", () -> robotContainer.getJoystick().getRawButton(4))
                .withWidget(BuiltInWidgets.kBooleanBox).withPosition(1, 2);
        Shuffleboard.getTab("Joystick").addBoolean("Button 3", () -> robotContainer.getJoystick().getRawButton(3))
                .withWidget(BuiltInWidgets.kBooleanBox).withPosition(1, 2);
        Shuffleboard.getTab("Joystick").addBoolean("Button 8", () -> robotContainer.getJoystick().getRawButton(8))
                .withWidget(BuiltInWidgets.kBooleanBox).withPosition(1, 2);
        Shuffleboard.getTab("Joystick").addBoolean("Button 7", () -> robotContainer.getJoystick().getRawButton(7))
                .withWidget(BuiltInWidgets.kBooleanBox).withPosition(1, 2);
        Shuffleboard.getTab("Joystick").addBoolean("Button 1", () -> robotContainer.getJoystick().getRawButton(1))
                .withWidget(BuiltInWidgets.kBooleanBox).withPosition(1, 2);
        Shuffleboard.getTab("Joystick").addBoolean("Button 2", () -> robotContainer.getJoystick().getRawButton(2))
                .withWidget(BuiltInWidgets.kBooleanBox).withPosition(1, 2);
        Shuffleboard.getTab("Joystick").addBoolean("Button 10", () -> robotContainer.getJoystick().getRawButton(10))
                .withWidget(BuiltInWidgets.kBooleanBox).withPosition(1, 2);
        Shuffleboard.getTab("Joystick").addBoolean("Button 5", () -> robotContainer.getJoystick().getRawButton(5))
                .withWidget(BuiltInWidgets.kBooleanBox).withPosition(1, 2);
    }
