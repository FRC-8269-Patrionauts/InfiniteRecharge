...
public class Dashboard extends CommandBase {
        ...
        public Dashboard(RobotContainer robotContainer) {
                ...
                if (Constants.ENABLE_BELT) {
                        configureBelt();
                }
                if (Constants.ENABLE_CAMERA) {
                        configureCamera();
                }
                if (Constants.ENABLE_COLORWHEEL) {
                        configureColorWheel();
                }
        }
        ...
        private void configureCommands() {
                ...
                Shuffleboard.getTab("ShootSubsystem").add("TestShoot", (Sendable) robotContainer.getTestShootCommand())
                                .withWidget(BuiltInWidgets.kCommand).withPosition(8, 1).withSize(2, 1);
                ...
                Shuffleboard.getTab("Commands")
                                .add("SetIntakePosition", (Sendable) robotContainer.getSetIntakeRollerCommand())
        ...
        public void configureBelt() {
                Shuffleboard.getTab("BeltSubsystem")
