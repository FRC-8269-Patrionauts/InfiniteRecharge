...
public class SmartDashboardCommand extends CommandBase {
    ...
    private void configureDriveSubsystem() {
        ...
        Shuffleboard.getTab("DriveSubsystem").addNumber("IMU Yaw", () -> robotContainer.getImu().getYaw())
                .withWidget(BuiltInWidgets.kDial).withProperties(Map.of("min", 0, "max", 360)).withPosition(0, 2);
        Shuffleboard.getTab("DriveSubsystem").addNumber("IMU Pitch", () -> robotContainer.getImu().getPitch())
                .withWidget(BuiltInWidgets.kDial).withProperties(Map.of("min", 0, "max", 360)).withPosition(1, 2);
        Shuffleboard.getTab("DriveSubsystem").addNumber("IMU Roll", () -> robotContainer.getImu().getRoll())
                .withWidget(BuiltInWidgets.kDial).withProperties(Map.of("min", 0, "max", 360)).withPosition(2, 2);
    }
    ...
    private void configureLimeLight() {
        Shuffleboard.getTab("LimeLight").addNumber("Area", () -> robotContainer.getDetectedTarget().getArea())
                .withPosition(0, 0);
        Shuffleboard.getTab("LimeLight").addNumber("X Offset", () -> robotContainer.getDetectedTarget().getXOffset())
                .withPosition(1, 0);
        Shuffleboard.getTab("LimeLight").addNumber("Y Offset", () -> robotContainer.getDetectedTarget().getYOffset())
                .withPosition(2, 0);
    }
}
